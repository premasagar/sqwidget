...
*Status*: Almost complete (requires small tweaks for IE6 and IE7).
...
*Status*: Stable. Additional methods to come.
...
Sqwidget is under rapid development at the moment. An initial release is anticipated around Summer 2010. However, some of the plugins listed above are ready for production. Further documentation, examples and tutorials are on their way.
