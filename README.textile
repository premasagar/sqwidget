...
Sqwidget is under rapid development at the moment. An initial release is anticipated around Autumn 2010. However, some of the plugins listed below are ready for production. See "the wiki":http://wiki.github.com/premasagar/sqwidget/ for emerging documentation, examples and tutorials.
...
A tiny, secure JavaScript micro-templating script. Tim lets you write simple templates that uses JavaScript's familiar dot notation. You pass in a JavaScript object that contains all the relevant strings, and they are then substited into the template.
...
"http://github.com/premasagar/sweeze":http://github.com/premasagar/sqweeze
