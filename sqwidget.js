...
define('component/core',['underscore', 'backbone'], function(_, Backbone) {
  var SqwidgetCore;
  return SqwidgetCore = (function() {
    ...
    SqwidgetCore.prototype.register = function(el) {
      ...
      require(["" + opts.url + ".js"], function(container) {
        return require(["src/index"], function(module) {
          var widget;
...
define('component/test',['component/core', 'jquery'], function(Core, $) {
  var sqwidget;
  sqwidget = new Core();
  return {
    el: function(el) {
...
requirejs(['jquery', 'component/core', 'component/test'], function($, Core) {
  var sqwidget;
  sqwidget = window.sqwidget = new Core();
  return $(document).ready(function() {
    return $('div[data-sqwidget]').each(function(index) {
      return sqwidget.register(this);
    });
  });
});

define("sqwidget", function(){});
